...
import {AiFillHome,AiOutlineCodeSandbox,AiFillStar,AiFillSetting } from 'react-icons/ai'
import {FiCommand} from 'react-icons/fi'
import {MdOutlineRecentActors} from 'react-icons/md'
import {BsFillBookmarkFill,BsDownload} from 'react-icons/bs'
...
export const menuItems = [
    {
        ...
        categoryItems: [
            ...
            name: "Home",
            link: "",
            icon:<AiFillHome className="h-full w-full"/>,
        }, {
            id: 2,
            name: "Discovery",
            link: "",
            icon: <ImEarth className="h-full w-full"/>,
        }, {
            id: 3,
            name: "Community",
            link: "",
            icon:<FiCommand className="h-full w-full"/>,
        }, {
            id: 4,
            name: "Comming soon",
            link: "",
            icon:<AiOutlineCodeSandbox className="h-full w-full"/>,
        }]
    }, {
        category: "Library",
        ...
        categoryItems: [
            {
                ...
                name: "Recent",
                link: "",
                icon:<MdOutlineRecentActors className="h-full w-full"/>,
            }
            ,
            {
                id: 6,
                name: "Bockmarked",
                link: "",
                icon:<BsFillBookmarkFill className="h-full w-full"/>,
            }
            , {
                id: 7,
                name: "Top rated",
                link: "",
                icon:<AiFillStar className="h-full w-full"/>,
            }
            , {
                id: 8,
                name: "Downloaded",
                link: "",
                icon:<BsDownload className="h-full w-full"/>,
            }
        ]
    }, {
        category: "General",
        categoryItems: [
            {
                ...
                name: "Settings",
                link: "",
                icon:<AiFillSetting className="h-full w-full"/>,
            }, {
                id: 10,
                name: "Help",
                link: "",
                icon:<BiHelpCircle className="h-full w-full"/>,
            }
        ]
    }
]
...
export const films = [
    ...
    {
        id: 7,
        title: "Roald Dahs Matilda the Musical",
